...
char ssid[] = "1871GUEST"; //  your network SSID (name)
char pass[] = "Welcome1871!"; // your network password (use for WPA, or use as key for WEP)
int keyIndex = 0;            // your network key Index number (needed only for WEP)

int status = WL_IDLE_STATUS;

char deviceId[] = "2f1801ace7571dd7c0cc6a6a8a882820"; // Feed you want to post to
char m2xKey[] = "e346cbb02a3e83643da53593408795e0"; // Your M2X access key
